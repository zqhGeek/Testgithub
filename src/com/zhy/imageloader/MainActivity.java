...
import com.zhy.imageloader.MyAdapter.Photo;

public class MainActivity extends Activity implements OnImageDirSelected, Photo {
	private String Camerapath = "";
	public static String CAMERA = "camera";
	private static final int TAKE_PICTURE = 0;
	private ProgressDialog mProgressDialog;
	private String DCIMpath = "/storage/emulated/0/DCIM/Camera";
	/**
	 * 存储文件夹中的图片数量
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.forum_photo);
	...
	private void initView() {
		...
		mFinish = (Button) findViewById(R.id.id_finish);
		...
		mFinish.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("mSelectedImage",(Serializable) MyAdapter.mSelectedImage);
